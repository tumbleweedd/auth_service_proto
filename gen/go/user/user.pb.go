...
var file_user_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x32, 0xb2, 0x02,
	0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x3d, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x00, 0x12, 0x34, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	...
	0x2f, 0x74, 0x75, 0x6d, 0x62, 0x6c, 0x65, 0x77, 0x65, 0x65, 0x64, 0x64, 0x2f, 0x61, 0x75, 0x74,
	0x68, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
var file_user_user_proto_depIdxs = []int32{
	...
	1,  // 2: auth.User.Create:input_type -> auth.CreateUserRequest
	3,  // 3: auth.User.Update:input_type -> auth.UpdateUserRequest
	5,  // 4: auth.User.Delete:input_type -> auth.DeleteUserRequest
	6,  // 5: auth.User.Get:input_type -> auth.GetUserRequest
	8,  // 6: auth.User.List:input_type -> auth.ListUsersRequest
	2,  // 7: auth.User.Create:output_type -> auth.CreateUserResponse
	4,  // 8: auth.User.Update:output_type -> auth.UpdateUserResponse
	10, // 9: auth.User.Delete:output_type -> google.protobuf.Empty
	7,  // 10: auth.User.Get:output_type -> auth.GetUserResponse
	9,  // 11: auth.User.List:output_type -> auth.ListUsersResponse
